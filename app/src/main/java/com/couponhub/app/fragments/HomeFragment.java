...
import com.couponhub.app.activities.TopStoresDetailsActivity;
import com.couponhub.app.activities.ViewAllTopOffersActivity;
import com.couponhub.app.adapter.TodayBestOfferListAdapter;

import com.couponhub.app.adapter.TopStoresAdapter;
...
import com.couponhub.app.utils.Sliding_Adapter_For_viewpager_main;
...
public class HomeFragment extends Fragment implements View.OnClickListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    private void getAllOffersData() {
        ...
        Call<AllOffersDataModel> call = apiService.getOffers(Constants.getSharedPreferenceInt(mActivity,"userId",0),
                Constants.getSharedPreferenceString(mActivity,"securitytoken",""), BuildConfig.VERSION_NAME,
