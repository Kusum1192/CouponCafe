...
import com.couponhub.app.activities.NotificationActivity;
import com.couponhub.app.activities.UserTransactionsActivity;
import com.couponhub.app.fragments.CategoriesFragment;
import com.couponhub.app.fragments.HelpFragment;
import com.couponhub.app.fragments.HomeFragment;
import com.couponhub.app.fragments.InviteAndEarnFragment;
import com.couponhub.app.fragments.ProfileFragment;
...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*Picasso.get().load(Constants.getSharedPreferenceString(MainActivity.this, "userimage", ""))
                .into((imageView));*/
       Glide.with(this)
                .load(Constants.getSharedPreferenceString(MainActivity.this, "userimage", ""))
                .into(imageView);
    }
